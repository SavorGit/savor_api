...
class BootsituationController extends CommonController{
    ...
    public function getHotelsByMainId(){
        $all_main_hotels = array(
            250=>array('name'=>'宝燕壹号','hotel_ids'=>'250,251,253,256,257,262,263,265,255,252,258,285,254,260,261,264'),
            330=>array('name'=>'榕港','hotel_ids'=>'331,630,332,330,671,483,807,338,533,490,337,336,335,333'),
        );
