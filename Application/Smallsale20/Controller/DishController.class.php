...
class DishController extends CommonController{
    ...
    public function goodslist(){
        ...
        if($res_goods['total']){
            ...
            foreach ($res_goods['list'] as $v){
                ...
                $qrcode = $host_name."/Smallsale20/qrcode/dishQrcode?data_id={$v['id']}&type=25";
                if($v['type']==22){
                    $qrcode = $host_name."/Smallsale20/qrcode/dishQrcode?data_id={$v['id']}&type=26";
                }
    ...
    public function detail(){
        ...
        $host_name = 'https://'.$_SERVER['HTTP_HOST'];
        $qrcode = $host_name."/Smallsale20/qrcode/dishQrcode?data_id={$goods_id}&type=25";
        $income_fee = 0;
        if($res_goods['type']==22){
            if($openid){
                ...
                $qrcode = $host_name."/Smallsale20/qrcode/dishQrcode?data_id={$goods_id}&suid=$sale_uid&type=26";
                ...
                $qrcode = $host_name."/Smallsale20/qrcode/dishQrcode?data_id={$goods_id}&type=26";
            }
        }
