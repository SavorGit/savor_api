...
class WelcomeController extends CommonController{
    ...
    public function addwelcome(){
        ...
        $is_all = intval($this->params['is_all']);
        ...
        if($is_all==1){
            ...
            $box_mac_arr = explode(',',$box_mac);
            foreach ($box_mac_arr as $v){
                if(!empty($v)){
                    $part_box_mac[]=$v;
                }
            }
